...
function Footer() {
  return (
    ...
    <div className='max-w-[1000px] gap-2 md:gap-10 justify-center items-center m-auto grid grid-cols-[2fr_1fr_1fr_1fr] mt-16 '>
        <div className='md:text-[16px] text-[12px]'>
            ...
            <div className='flex '>  
               ...
               <p className='font-bold text-[13px] px-1  md:text-[24px ]'> NATSENT iPhone Store</p>
            </div>


            <p className='flex-wrap md:text-[16px] text-[12px] pt-8'>many say exploration i part of our destiny it is actually our future.</p>
